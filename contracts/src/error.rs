...
pub enum AethelError {
    ...
    #[error("Pipeline step {step_index} failed: {reason}")]
    PipelineStepFailed { step_index: usize, reason: String },
...
mod tests {
    ...
    fn test_all_variants_have_display() {
        ...
        let errors = vec![
            ...
            AethelError::PipelineStepFailed { step_index: 0, reason: "test".into() },
